...
The web track can proceed in parallel: `WEB PHASE 0`–`5` are unblocked now (API Phases 1–5 are done). Run web phases as their own Codex sessions against `prompts/web.md`, same stop-at-the-line discipline.
