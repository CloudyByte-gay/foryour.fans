...
The web track can proceed in parallel: `WEB PHASE 0`–`6` are unblocked now (API Phases 1–6 are done). Run web phases as their own Codex sessions against `prompts/web.md`, same stop-at-the-line discipline.
