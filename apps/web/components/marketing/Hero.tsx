  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-20 text-center sm:py-28">
      ...
      <p className="mx-auto mt-5 max-w-2xl text-balance text-lg text-muted">
        Your identity is a portable AT Protocol account — a DID, not a username and password we
        own. Publish public posts to the open network, and keep subscriber-only content private to
