...
export const metadata: Metadata = {
  title: "About",
  description:
    "foryour.fans is a paid creator platform built on Bluesky's AT Protocol, so identity and audience stay portable.",
    ...
    <article className="mx-auto max-w-2xl px-4 py-16">
      ...
      <div className="mt-6 space-y-6 text-muted">
        <p>
          ...
          <span className="text-foreground">Bluesky's open network, the AT Protocol</span>.
        </p>

        <h2 className="font-display text-xl font-semibold text-foreground">
          Why Bluesky and the AT Protocol
        </h2>
        <p>
          On most creator platforms your account, your followers and your content live inside one
          company's database. Leaving means starting over. On the AT Protocol — the open network
          behind Bluesky — your identity is a{" "}
        ...
        <p>
          Public posts are AT Protocol records: other apps on the network — including Bluesky — can
          read and replicate them. Subscriber-only content is deliberately{" "}
